...
fretboard = SeeFretboard("h", 1, 15, theme="blue")
...
fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
fretboard.addDropChord("c", "maj7","Drop2", "2", octHigher="yes")#gotta be an octave higher or else goes off screen
fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "dom7","Drop2", "2", octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "min7","Drop2", "2", octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "min7b5","Drop2", "2", octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "dim7","Drop2", "2", octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "maj7","Drop3", "2","6",octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "dom7","Drop3", "2","6", octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "min7","Drop3", "2","6", octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "min7b5","Drop3", "2","6", octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
...
# fretboard.fretboardTheme.fretboardDesign.setNoteType("black")
# fretboard.addDropChord("c", "dim7","Drop3", "2","6", octHigher="yes")
# fretboard.fretboardTheme.fretboardDesign.setNoteType("green")
